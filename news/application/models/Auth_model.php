...
class Auth_model extends CI_Model
{
	...
	public function login()
	{
		...
		if (!empty($user)) {
			...
			$user_data = array(
				'csac_ses_id' => $user->id,
				'csac_ses_username' => $user->username,
				'csac_ses_email' => $user->email,
				'csac_ses_role' => $user->role,
				'csac_ses_logged_in' => true,
				'csac_ses_app_key' => $this->config->item('app_key'),
			);
	...
	{
		//unset user data
		$this->session->unset_userdata('csac_ses_id');
		$this->session->unset_userdata('csac_ses_username');
		$this->session->unset_userdata('csac_ses_email');
		$this->session->unset_userdata('csac_ses_role');
		$this->session->unset_userdata('csac_ses_logged_in');
		$this->session->unset_userdata('csac_ses_app_key');
	}
	...
	public function is_logged_in()
	{
		...
		if ($this->session->userdata('csac_ses_logged_in') == true && $this->session->userdata('csac_ses_app_key') == $this->config->item('app_key') && !empty($user)) {
	...
	public function is_admin()
	{
		...
		//check role
		if ($this->session->userdata('csac_ses_role') == 'admin') {
			return true;
		} else {
			return false;
		}
	...
	public function is_author()
	{
		...
		//check role
		if ($this->session->userdata('csac_ses_role') == 'author') {
			return true;
		} else {
			return false;
		}
	...
	{
		if ($this->session->userdata('csac_ses_logged_in') == true) {
	...
	{
		return $this->session->userdata('csac_ses_id');
	}

	//get logged username
	public function get_username()
	{
		return $this->session->userdata('csac_ses_username');
	}
